...
const allGenres = Object.keys(genres.movies)
  .map((x, index) => genres.movies[index].name)
  .concat(
    Object.keys(genres.tvSeries).map((x, index) => genres.tvSeries[index].name)
  )
  .sort();
